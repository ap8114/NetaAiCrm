...
const RightSection = ({ toggleProfileDropdown, showProfileDropdown, isAdmin, setShowActivityPanel, navigate, profileRef, setShowNotificationModal }) => (
    <div className="d-flex align-items-center gap-3" ref={profileRef}>
        ...
        {showProfileDropdown && <ProfileDropdown isAdmin={isAdmin} navigate={navigate} setShowNotificationModal={setShowNotificationModal} />}
    </div>
);
